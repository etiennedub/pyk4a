...
const int RESOLUTION_TO_DIMS[][2] = {{0, 0},       {1280, 720},  {1920, 1080},
                                     {2560, 1440}, {2048, 1536}, {3840, 2160},
                                     {4096, 3072}};
...
static void capsule_cleanup_device(PyObject *capsule) {
  ...
  device_handle =
      (k4a_device_t *)PyCapsule_GetPointer(capsule, CAPSULE_DEVICE_NAME);
  free(device_handle);
}
...
static void capsule_cleanup_calibration(PyObject *capsule) {
  k4a_calibration_t *calibration = (k4a_calibration_t *)PyCapsule_GetPointer(
      capsule, CAPSULE_CALIBRATION_NAME);
  free(calibration);
}

static void capsule_cleanup_capture(PyObject *capsule) {
  k4a_capture_t *capture =
      (k4a_capture_t *)PyCapsule_GetPointer(capsule, CAPSULE_CAPTURE_NAME);
...
static void capsule_cleanup_playback(PyObject *capsule) {
  ...
  playback_handle =
      (k4a_playback_t *)PyCapsule_GetPointer(capsule, CAPSULE_PLAYBACK_NAME);
  free(playback_handle);
}

static void capsule_cleanup_transformation(PyObject *capsule) {
  k4a_transformation_t *transformation =
      (k4a_transformation_t *)PyCapsule_GetPointer(capsule,
                                                   CAPSULE_TRANSFORMATION_NAME);
...
static PyObject *device_open(PyObject *self, PyObject *args) {
  ...
  PyObject *capsule =
      PyCapsule_New(device_handle, CAPSULE_DEVICE_NAME, capsule_cleanup_device);
...
static PyObject *device_get_sync_jack(PyObject *self, PyObject *args) {
  ...
  thread_state = _gil_release(thread_safe);
  k4a_result_t result =
      k4a_device_get_sync_jack(*device_handle, &in_jack, &out_jack);
  _gil_restore(thread_state);
...
static PyObject *device_get_color_control(PyObject *self, PyObject *args) {
  ...
  thread_state = _gil_release(thread_safe);
  k4a_result_t result =
      k4a_device_get_color_control(*device_handle, command, &mode, &value);
  _gil_restore(thread_state);
...
static PyObject *device_set_color_control(PyObject *self, PyObject *args) {
  ...
  PyArg_ParseTuple(args, "OpIIi", &capsule, &thread_safe, &command, &mode,
                   &value);
  device_handle =
      (k4a_device_t *)PyCapsule_GetPointer(capsule, CAPSULE_DEVICE_NAME);
  ...
  thread_state = _gil_release(thread_safe);
  k4a_result_t result =
      k4a_device_set_color_control(*device_handle, command, mode, value);
  _gil_restore(thread_state);
...
static PyObject *device_get_color_control_capabilities(PyObject *self,
                                                       PyObject *args) {
  k4a_device_t *device_handle;
  PyObject *capsule;
  int thread_safe;
  ...
  return Py_BuildValue(
      "I{s:I,s:N,s:i,s:i,s:i,s:i,s:I}", result, "color_control_command",
      command, "supports_auto", supports_auto ? Py_True : Py_False, "min_value",
      min_value, "max_value", max_value, "step_value", step_value,
      "default_value", default_value, "default_mode", default_mode);
}
...
static PyObject *device_start_cameras(PyObject *self, PyObject *args) {
  ...
  PyArg_ParseTuple(
      args, "OpIIIIpiIIp", &capsule, &thread_safe, &config.color_format,
      &config.color_resolution, &config.depth_mode, &config.camera_fps,
      &config.synchronized_images_only, &config.depth_delay_off_color_usec,
...
static PyObject *device_get_capture(PyObject *self, PyObject *args) {
  ...
  PyObject *capsule_capture =
      PyCapsule_New(capture, CAPSULE_CAPTURE_NAME, capsule_cleanup_capture);
...
static PyObject *device_get_imu_sample(PyObject *self, PyObject *args) {
  ...
  if (K4A_WAIT_RESULT_SUCCEEDED == result) {
    return Py_BuildValue(
        "I{s:f,s:(fff),s:L,s:(fff),s:L}", result, "temperature",
        imu_sample.temperature, "acc_sample", imu_sample.acc_sample.xyz.x,
        imu_sample.acc_sample.xyz.y, imu_sample.acc_sample.xyz.z,
        "acc_timestamp", imu_sample.acc_timestamp_usec, "gyro_sample",
        imu_sample.gyro_sample.xyz.x, imu_sample.gyro_sample.xyz.y,
        imu_sample.gyro_sample.xyz.z, "gyro_timestamp",
...
static PyObject *calibration_get_from_raw(PyObject *self, PyObject *args) {
  ...
  PyArg_ParseTuple(args, "psII", &thread_safe, &raw_calibration, &depth_mode,
                   &color_resolution);
  ...
  thread_state = _gil_release(thread_safe);
  result = k4a_calibration_get_from_raw(raw_calibration, raw_calibration_size,
                                        depth_mode, color_resolution,
                                        calibration_handle);
  if (result == K4A_RESULT_FAILED) {
    _gil_restore(thread_state);
    return Py_BuildValue("IN", result, Py_None);
  ...
  PyObject *calibration_capsule =
      PyCapsule_New(calibration_handle, CAPSULE_CALIBRATION_NAME,
                    capsule_cleanup_calibration);
...
static PyObject *device_get_calibration(PyObject *self, PyObject *args) {
  ...
  PyArg_ParseTuple(args, "OpII", &capsule, &thread_safe, &depth_mode,
                   &color_resolution);
  device_handle =
      (k4a_device_t *)PyCapsule_GetPointer(capsule, CAPSULE_DEVICE_NAME);

  k4a_calibration_t *calibration_handle =
      (k4a_calibration_t *)malloc(sizeof(k4a_calibration_t));
  if (calibration_handle == NULL) {
    fprintf(stderr, "Cannot allocate memory");
    return Py_BuildValue("IN", K4A_RESULT_FAILED, Py_None);
  }
  ...
  thread_state = _gil_release(thread_safe);
  result = k4a_device_get_calibration(*device_handle, depth_mode,
...
k4a_result_t k4a_image_to_numpy(k4a_image_t *img_src, PyArrayObject **img_dst) {
  ...
  case K4A_IMAGE_FORMAT_COLOR_BGRA32:
    ...
    dims[2] = 4;
    *img_dst =
        (PyArrayObject *)PyArray_SimpleNewFromData(3, dims, NPY_UINT8, buffer);
    break;
  case K4A_IMAGE_FORMAT_COLOR_MJPG:
    dims[0] = k4a_image_get_size(*img_src);
    *img_dst =
        (PyArrayObject *)PyArray_SimpleNewFromData(1, dims, NPY_UINT8, buffer);
    break;
  ...
  case K4A_IMAGE_FORMAT_IR16:
    ...
    dims[1] = k4a_image_get_width_pixels(*img_src);
    *img_dst =
        (PyArrayObject *)PyArray_SimpleNewFromData(2, dims, NPY_UINT16, buffer);
    break;
  case K4A_IMAGE_FORMAT_CUSTOM:
    ...
    dims[2] = 3;
    *img_dst =
        (PyArrayObject *)PyArray_SimpleNewFromData(3, dims, NPY_INT16, buffer);
    break;
  default:
    // Not supported
...
k4a_result_t numpy_to_k4a_image(PyArrayObject *img_src, k4a_image_t *img_dst,
  ...
  return k4a_image_create_from_buffer(
      format, width_pixels, height_pixels, width_pixels * pixel_size,
      (uint8_t *)img_src->data, width_pixels * height_pixels * pixel_size, NULL,
      NULL, img_dst);
}
...
static PyObject *transformation_create(PyObject *self, PyObject *args) {
  ...
  PyArg_ParseTuple(args, "Op", &capsule, &thread_safe);
  calibration_handle = (k4a_calibration_t *)PyCapsule_GetPointer(
      capsule, CAPSULE_CALIBRATION_NAME);

  thread_state = _gil_release(thread_safe);

  k4a_transformation_t *transformation_handle =
      (k4a_transformation_t *)malloc(sizeof(k4a_transformation_t));
  if (calibration_handle == NULL) {
    fprintf(stderr, "Cannot allocate memory");
  ...
  *transformation_handle = k4a_transformation_create(calibration_handle);
  ...
  PyObject *transformation_capsule =
      PyCapsule_New(transformation_handle, CAPSULE_TRANSFORMATION_NAME,
                    capsule_cleanup_transformation);

  return Py_BuildValue("N", transformation_capsule);
}

static PyObject *transformation_depth_image_to_color_camera(PyObject *self,
                                                            PyObject *args) {
  k4a_transformation_t *transformation_handle;
  PyObject *capsule;
  int thread_safe;
  ...
  PyArg_ParseTuple(args, "OpO!I", &capsule, &thread_safe, &PyArray_Type,
                   &in_array, &color_resolution);
  transformation_handle = (k4a_transformation_t *)PyCapsule_GetPointer(
      capsule, CAPSULE_TRANSFORMATION_NAME);

  k4a_image_t *depth_image_transformed =
      (k4a_image_t *)malloc(sizeof(k4a_image_t));

  k4a_image_t depth_image;
  res = numpy_to_k4a_image(in_array, &depth_image, K4A_IMAGE_FORMAT_DEPTH16);
  thread_state = _gil_release(thread_safe);
  if (K4A_RESULT_SUCCEEDED == res) {
    res = k4a_image_create(k4a_image_get_format(depth_image),
  ...
  if (K4A_RESULT_SUCCEEDED == res) {
    res = k4a_transformation_depth_image_to_color_camera(
        *transformation_handle, depth_image, *depth_image_transformed);
...
static PyObject *
transformation_depth_image_to_color_camera_custom(PyObject *self,
                                                  PyObject *args) {
  k4a_transformation_t *transformation_handle;
  PyObject *capsule;
  int thread_safe;
  ...
  PyArg_ParseTuple(args, "OpO!O!Ip", &capsule, &thread_safe, &PyArray_Type,
                   &d_array, &PyArray_Type, &c_array, &color_resolution,
                   &interp_nearest);
  ...
  k4a_image_t *depth_image_transformed =
      (k4a_image_t *)malloc(sizeof(k4a_image_t));
  k4a_image_t *custom_image_transformed =
      (k4a_image_t *)malloc(sizeof(k4a_image_t));
  ...
  if (K4A_RESULT_SUCCEEDED == res) {
    res = k4a_image_create(k4a_image_get_format(custom_image),
                           RESOLUTION_TO_DIMS[color_resolution][0],
                           RESOLUTION_TO_DIMS[color_resolution][1],
                           RESOLUTION_TO_DIMS[color_resolution][0] *
  ...
  if (K4A_RESULT_SUCCEEDED == res) {
    res = k4a_transformation_depth_image_to_color_camera_custom(
        ...
        *depth_image_transformed, *custom_image_transformed, interpolation_type,
        0);
    k4a_image_release(depth_image);
...
static PyObject *transformation_depth_image_to_point_cloud(PyObject *self,
                                                           PyObject *args) {
  k4a_transformation_t *transformation_handle;
  PyObject *capsule;
  int thread_safe;
  ...
  PyArg_ParseTuple(args, "OpO!p", &capsule, &thread_safe, &PyArray_Type,
                   &depth_in_array, &calibration_type_depth);
  transformation_handle = (k4a_transformation_t *)PyCapsule_GetPointer(
      capsule, CAPSULE_TRANSFORMATION_NAME);
  ...
  k4a_image_t depth_image;
  res = numpy_to_k4a_image(depth_in_array, &depth_image,
                           K4A_IMAGE_FORMAT_DEPTH16);
  thread_state = _gil_release(thread_safe);
  if (K4A_RESULT_SUCCEEDED == res) {
    res = k4a_image_create(
        K4A_IMAGE_FORMAT_CUSTOM, k4a_image_get_width_pixels(depth_image),
...
static PyObject *transformation_color_image_to_depth_camera(PyObject *self,
                                                            PyObject *args) {
  k4a_transformation_t *transformation_handle;
  PyObject *capsule;
  int thread_safe;
  ...
  PyArg_ParseTuple(args, "OpO!O!", &capsule, &thread_safe, &PyArray_Type,
                   &in_depth_array, &PyArray_Type, &in_color_array);
  transformation_handle = (k4a_transformation_t *)PyCapsule_GetPointer(
      capsule, CAPSULE_TRANSFORMATION_NAME);
  ...
  res = numpy_to_k4a_image(in_depth_array, &depth_image,
                           K4A_IMAGE_FORMAT_DEPTH16);
  if (K4A_RESULT_SUCCEEDED == res) {
    res = numpy_to_k4a_image(in_color_array, &color_image,
                             K4A_IMAGE_FORMAT_COLOR_BGRA32);
    if (K4A_RESULT_SUCCEEDED == res) {
      res = k4a_image_create(K4A_IMAGE_FORMAT_COLOR_BGRA32,
...
static PyObject *calibration_3d_to_3d(PyObject *self, PyObject *args) {
  ...
  PyArg_ParseTuple(args, "Op(fff)II", &capsule, &thread_safe, &source_point_x,
                   &source_point_y, &source_point_z, &source_camera,
                   &target_camera);
  calibration_handle = (k4a_calibration_t *)PyCapsule_GetPointer(
      capsule, CAPSULE_CALIBRATION_NAME);
  ...
  res = k4a_calibration_3d_to_3d(calibration_handle, &source_point3d_mm,
  ...
  return Py_BuildValue("I(fff)", res, target_point3d_mm.xyz.x,
...
static PyObject *calibration_2d_to_3d(PyObject *self, PyObject *args) {
  ...
  PyArg_ParseTuple(args, "Op(ff)fII", &capsule, &thread_safe, &source_point_x,
                   &source_point_y, &source_depth_mm, &source_camera,
                   &target_camera);
  calibration_handle = (k4a_calibration_t *)PyCapsule_GetPointer(
      capsule, CAPSULE_CALIBRATION_NAME);
  ...
  res = k4a_calibration_2d_to_3d(calibration_handle, &source_point2d,
                                 source_depth_mm, source_camera, target_camera,
  ...
  // Return object...
  return Py_BuildValue("II(fff)", res, valid, target_point3d_mm.xyz.x,
                       target_point3d_mm.xyz.y, target_point3d_mm.xyz.z);
}
...
static PyObject *playback_open(PyObject *self, PyObject *args) {
  ...
  k4a_playback_t *playback_handle =
      (k4a_playback_t *)malloc(sizeof(k4a_playback_t));
  ...
  PyObject *capsule = PyCapsule_New(playback_handle, CAPSULE_PLAYBACK_NAME,
                                    capsule_cleanup_playback);
  return Py_BuildValue("IN", result, capsule);
}
...
static PyObject *playback_get_recording_length_usec(PyObject *self,
                                                    PyObject *args) {
...
static PyObject *playback_get_record_configuration(PyObject *self,
                                                   PyObject *args) {
  int thread_safe;
  PyThreadState *thread_state;
  PyObject *capsule;
  ...
  return Py_BuildValue(
      "I(IIIIiiiiIIII)", result, config.color_format, config.color_resolution,
      config.depth_mode, config.camera_fps, config.color_track_enabled,
      config.depth_track_enabled, config.ir_track_enabled,
      config.imu_track_enabled, config.depth_delay_off_color_usec,
      config.wired_sync_mode, config.subordinate_delay_off_master_usec,
...
static PyMethodDef Pyk4aMethods[] = {
    ...
    {"device_start_cameras", device_start_cameras, METH_VARARGS,
     "Starts color and depth camera capture"},
    {"device_stop_cameras", device_stop_cameras, METH_VARARGS,
    ...
    {"device_get_capture", device_get_capture, METH_VARARGS,
    ...
    {"capture_get_ir_image", capture_get_ir_image, METH_VARARGS,
     "Set or add a IR image to the associated capture"},
    {"device_get_imu_sample", device_get_imu_sample, METH_VARARGS,
     "Reads an imu sample"},
    {"device_close", device_close, METH_VARARGS,
     "Close an Azure Kinect device"},
    ...
    {"device_get_color_control", device_get_color_control, METH_VARARGS,
     "Get device color control."},
    {"device_set_color_control", device_set_color_control, METH_VARARGS,
     "Set device color control."},
    {"device_get_color_control_capabilities",
     device_get_color_control_capabilities, METH_VARARGS,
     "Get device color control capabilities."},
    {"device_get_calibration", device_get_calibration, METH_VARARGS,
     "Get device calibration handle."},
    ...
    {"transformation_create", transformation_create, METH_VARARGS,
     "Create transformation handle from calibration"},
    {"transformation_depth_image_to_color_camera",
     transformation_depth_image_to_color_camera, METH_VARARGS,
     "Transforms the depth map into the geometry of the color camera."},
    {"transformation_depth_image_to_color_camera_custom",
     transformation_depth_image_to_color_camera_custom, METH_VARARGS,
     "Transforms the custom & depth map into the geometry of the color "
     "camera."},
    {"transformation_color_image_to_depth_camera",
     transformation_color_image_to_depth_camera, METH_VARARGS,
     "Transforms the color image into the geometry of the depth camera."},
    {"transformation_depth_image_to_point_cloud",
     transformation_depth_image_to_point_cloud, METH_VARARGS,
     "Transforms the depth map to a point cloud."},
    {"calibration_3d_to_3d", calibration_3d_to_3d, METH_VARARGS,
     "Transforms the coordinates between 2 3D systems"},
    ...
    {"playback_get_recording_length_usec", playback_get_recording_length_usec,
     METH_VARARGS, "Return recording length"},
    ...
    {"playback_seek_timestamp", playback_seek_timestamp, METH_VARARGS,
     "Seek playback file to specified position"},
    {"playback_get_record_configuration", playback_get_record_configuration,
     METH_VARARGS, "Extract record configuration"},
    {"playback_get_next_capture", playback_get_next_capture, METH_VARARGS,
     "Get next capture from playback"},
    {"playback_get_previous_capture", playback_get_previous_capture,
     METH_VARARGS, "Get previous capture from playback"},
